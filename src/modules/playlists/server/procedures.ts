...
export const playlistsRouter = createTRPCRouter({
    ...
    removeVideo: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            ...
            if (!existingPlaylistVideo) {
                throw new TRPCError({ code: "NOT_FOUND", message: "Video does not exist in the playlist" });
            }
    ...
    addVideo: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            ...
            if (existingPlaylistVideo) {
                throw new TRPCError({ code: "BAD_REQUEST", message: "Video already exists in the playlist" });
            }
    ...
    getManyForVideo: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            ...
            try {
                console.log("getManyForVideo Input:", { userId, videoId, cursor, limit });
                ...
                console.log("getManyForVideo Result:", data);
                ...
                console.error("getManyForVideo Error:", error);
                throw new TRPCError({
