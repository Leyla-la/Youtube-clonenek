            ...
            >
                ...
                {user.clerkId === userId && (
                    <Button
                        ...
                        type="button"
                        size="icon"
                        className="absolute top-4 right-4 bg-black/50 hover:bg-black/50 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    >
