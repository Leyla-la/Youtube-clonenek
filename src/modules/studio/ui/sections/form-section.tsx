...
import { CopyCheckIcon, CopyIcon, Globe2Icon, ImagePlusIcon, Loader2Icon, LockIcon, MoreVerticalIcon, RotateCcw, RotateCcwIcon, SparkleIcon, SparklesIcon, TrashIcon } from "lucide-react";
...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const restoreThumbnail = trpc.videos.restoreThumbnail.useMutation({
        onSuccess: () => {
            utils.studio.getMany.invalidate();
            utils.studio.getOne.invalidate({ id: videoId });
            toast.error("Thumbnail restored");
        },
        onError: () => {
            toast.error("Something went wrong");
        }
    ...
    const generateTitle = trpc.videos.generateTitle.useMutation({
        onSuccess: (data) => {  // 'data' is the response (e.g., workflowRunId from procedures.ts)
            console.log('Mutation success:', data);  // Log success details for debugging
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <Button size="icon" variant="outline" type="button"
                                                    ...
                                                    {/* tu them video.muxtrackid o mmuc nay */}
                                        ...
                                        <FormControl>
                                            <Input
                                                {...field} placeholder="Add a title to your video"
                                            />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="p-0.5 border border-dashed border-neutral-400 relative h-[84px] w-[153px] group">
                                                <Image fill alt="Thumbnail" src={video.thumbnailUrl || THUMBNAIL_FALLBACK} className="object-cover" />
                                                <DropdownMenu>
                                                    <DropdownMenuTrigger asChild>
                                                    ...
                                                    <DropdownMenuContent align="start" side="right" >
                                                        ...
                                                        <DropdownMenuItem onClick={() => setThumbnailGenerateModalOpen(true)}>
                                                            <SparkleIcon className="size-4 mr-1" /> AI-generated
                                                        </DropdownMenuItem>
